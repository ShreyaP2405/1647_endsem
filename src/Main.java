...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        backlog.addIssue("install chrome", 5);
        backlog.addIssue("register for moodle", 13);
        backlog.addIssue("log in into the moodle", 21);
        backlog.addIssue("deal with client's requirements", 56);
        ...
        backlogs.get(0).addToSprint("deal with client's requirements", sprintBacklog);
